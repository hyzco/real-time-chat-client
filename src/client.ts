...
import ChatClientWithSocketIO from "./SocketClient.class";
import SocketUser from "./SocketUser.class";
...
const CreateClient = () => {
  return new Promise((resolve, reject) => {
    try {
      ...
      const user = new SocketUser(username);
      const client = new ChatClientWithSocketIO(
        user,
